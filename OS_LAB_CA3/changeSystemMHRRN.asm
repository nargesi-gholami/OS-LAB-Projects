...
_changeSystemMHRRN:     file format elf32-i386
  ...
  15:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  2b:	e8 4b 03 00 00       	call   37b <changeSystemMHRRN>
    printf(1, "Returned from changeSystemMHRRN()\n");
  30:	5a                   	pop    %edx
  31:	59                   	pop    %ecx
  32:	68 a8 07 00 00       	push   $0x7a8
  37:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb e0 07 00 00       	mov    $0x7e0,%ebx
        while(*s != 0){
