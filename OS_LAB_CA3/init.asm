...
main(void)
{
  ...
  27:	0f 88 b9 00 00 00    	js     e6 <main+0xe6>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  84:	e8 67 04 00 00       	call   4f0 <printf>
    pid = fork();
  89:	e8 dd 02 00 00       	call   36b <fork>
    if(pid < 0){
  ...
  95:	78 18                	js     af <main+0xaf>
      printf(1, "init: fork failed\n");
      exit();
    }
    if(pid == 0){
  97:	74 29                	je     c2 <main+0xc2>
  ...
  ab:	75 f3                	jne    a0 <main+0xa0>
  ad:	eb a1                	jmp    50 <main+0x50>
      printf(1, "init: fork failed\n");
  af:	53                   	push   %ebx
  b0:	53                   	push   %ebx
  b1:	68 a5 08 00 00       	push   $0x8a5
  b6:	6a 01                	push   $0x1
  b8:	e8 33 04 00 00       	call   4f0 <printf>
      exit();
  bd:	e8 b1 02 00 00       	call   373 <exit>
      exec("sh", argv);
  c2:	50                   	push   %eax
  c3:	50                   	push   %eax
  c4:	68 84 0b 00 00       	push   $0xb84
  c9:	68 b8 08 00 00       	push   $0x8b8
  ce:	e8 d8 02 00 00       	call   3ab <exec>
      printf(1, "init: exec sh failed\n");
  d3:	5a                   	pop    %edx
  d4:	59                   	pop    %ecx
  d5:	68 bb 08 00 00       	push   $0x8bb
  da:	6a 01                	push   $0x1
  dc:	e8 0f 04 00 00       	call   4f0 <printf>
      exit();
  e1:	e8 8d 02 00 00       	call   373 <exit>
    mknod("console", 1, 1);
  e6:	51                   	push   %ecx
  e7:	6a 01                	push   $0x1
  e9:	6a 01                	push   $0x1
  eb:	68 58 08 00 00       	push   $0x858
  f0:	e8 c6 02 00 00       	call   3bb <mknod>
    open("console", O_RDWR);
  f5:	5b                   	pop    %ebx
  f6:	58                   	pop    %eax
  f7:	6a 02                	push   $0x2
  f9:	68 58 08 00 00       	push   $0x858
  fe:	e8 b0 02 00 00       	call   3b3 <open>
 103:	83 c4 10             	add    $0x10,%esp
 106:	e9 22 ff ff ff       	jmp    2d <main+0x2d>
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 d8 08 00 00 	movzbl 0x8d8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb d1 08 00 00       	mov    $0x8d1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c5:	a1 8c 0b 00 00       	mov    0xb8c,%eax
{
 ...
 6e6:	73 10                	jae    6f8 <free+0x38>
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 719:	5d                   	pop    %ebp
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 8c 0b 00 00       	mov    %eax,0xb8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 75d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 760:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a9:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 8c 0b 00 00       	mov    0xb8c,%eax
 ...
 804:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 807:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
 ...
 81e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 8c 0b 00 00 90 	movl   $0xb90,0xb8c
 827:	0b 00 00 
    base.s.size = 0;
 82a:	bf 90 0b 00 00       	mov    $0xb90,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 90 0b 00 00 90 	movl   $0xb90,0xb90
 836:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 83b:	c7 05 94 0b 00 00 00 	movl   $0x0,0xb94
 842:	00 00 00 
    if(p->s.size >= nunits){
