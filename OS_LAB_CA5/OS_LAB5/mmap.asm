...
int main(int argc, char *argv[])
{
  ...
  1f:	e8 cf 02 00 00       	call   2f3 <open>
  ...
  2d:	6a 0a                	push   $0xa
  2f:	6a 00                	push   $0x0
  31:	e8 4d 03 00 00       	call   383 <mmap>
    text[0] = '1';
  36:	ba 31 32 00 00       	mov    $0x3231,%edx
    text[1] = '2';

    exit();
  3b:	83 c4 20             	add    $0x20,%esp
    text[0] = '1';
  3e:	66 89 10             	mov    %dx,(%eax)
    exit();
