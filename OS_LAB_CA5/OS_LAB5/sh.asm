...
00000e5b <sem_init>:
SYSCALL(sem_init)
     e5b:	b8 19 00 00 00       	mov    $0x19,%eax
     e60:	cd 40                	int    $0x40
     e62:	c3                   	ret    
