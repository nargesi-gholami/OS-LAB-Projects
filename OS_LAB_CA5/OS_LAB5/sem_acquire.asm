  ...
  15:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  2b:	e8 4b 03 00 00       	call   37b <sem_acquire>
    printf(1, "Returned from sem_acquire()\n");
  30:	5a                   	pop    %edx
  31:	59                   	pop    %ecx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb fa 07 00 00       	mov    $0x7fa,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 635:	a1 ac 0a 00 00       	mov    0xaac,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 ac 0a 00 00       	mov    %eax,0xaac
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d ac 0a 00 00    	mov    0xaac,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d ac 0a 00 00    	mov    0xaac,%edi
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 ac 0a 00 00       	mov    %eax,0xaac
}
 ...
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf b0 0a 00 00       	mov    $0xab0,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 b0 0a 00 00 b0 	movl   $0xab0,0xab0
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
