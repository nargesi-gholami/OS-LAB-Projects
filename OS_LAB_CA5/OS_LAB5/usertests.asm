...
00003a4b <sem_init>:
SYSCALL(sem_init)
    3a4b:	b8 19 00 00 00       	mov    $0x19,%eax
    3a50:	cd 40                	int    $0x40
    3a52:	c3                   	ret    
