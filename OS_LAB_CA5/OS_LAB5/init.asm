...
main(void)
{
  ...
  c2:	50                   	push   %eax
  c3:	50                   	push   %eax
  c4:	68 a4 0b 00 00       	push   $0xba4
  c9:	68 d8 08 00 00       	push   $0x8d8
  ce:	e8 d8 02 00 00       	call   3ab <exec>
      printf(1, "init: exec sh failed\n");
  d3:	5a                   	pop    %edx
  d4:	59                   	pop    %ecx
  d5:	68 db 08 00 00       	push   $0x8db
  da:	6a 01                	push   $0x1
  ...
  e7:	6a 01                	push   $0x1
  e9:	6a 01                	push   $0x1
  eb:	68 78 08 00 00       	push   $0x878
  f0:	e8 c6 02 00 00       	call   3bb <mknod>
    open("console", O_RDWR);
  f5:	5b                   	pop    %ebx
  f6:	58                   	pop    %eax
  f7:	6a 02                	push   $0x2
  f9:	68 78 08 00 00       	push   $0x878
 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 f8 08 00 00 	movzbl 0x8f8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	eb 1a                	jmp    6b0 <printf+0x1a0>
          s = "(null)";
 696:	bb f1 08 00 00       	mov    $0x8f1,%ebx
        while(*s != 0){
