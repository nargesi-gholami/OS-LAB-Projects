...
int main(int argc, char *argv[])
{
  ...
  6a:	d9 ee                	fldz   
  6c:	dd 05 00 08 00 00    	fldl   0x800
  72:	dc c1                	fadd   %st,%st(1)
  74:	d9 05 08 08 00 00    	flds   0x808
...
00000393 <changeQueue>:
 393:	b8 16 00 00 00       	mov    $0x16,%eax
 398:	cd 40                	int    $0x40
 39a:	c3                   	ret    

0000039b <printProcess>:
 39b:	b8 17 00 00 00       	mov    $0x17,%eax
 3a0:	cd 40                	int    $0x40
 3a2:	c3                   	ret    

000003a3 <changeProcessMHRRN>:
 3a3:	b8 18 00 00 00       	mov    $0x18,%eax
 3a8:	cd 40                	int    $0x40
 3aa:	c3                   	ret    

000003ab <changeSystemMHRRN>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb 0c 08 00 00       	mov    $0x80c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 655:	a1 bc 0a 00 00       	mov    0xabc,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 bc 0a 00 00       	mov    %eax,0xabc
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d bc 0a 00 00    	mov    0xabc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d bc 0a 00 00    	mov    0xabc,%edi
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 bc 0a 00 00       	mov    %eax,0xabc
}
 ...
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	bf c0 0a 00 00       	mov    $0xac0,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 c0 0a 00 00 c0 	movl   $0xac0,0xac0
 7c6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7cb:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 7d2:	00 00 00 
    if(p->s.size >= nunits){
