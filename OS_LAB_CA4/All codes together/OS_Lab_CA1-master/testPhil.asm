...
_testPhil:     file format elf32-i386
...
int main()
{
  ...
  16:	6a 01                	push   $0x1
  18:	6a 00                	push   $0x0
  1a:	e8 14 04 00 00       	call   433 <sem_init>
    sem_init(1, 1);
  1f:	58                   	pop    %eax
  20:	5a                   	pop    %edx
  21:	6a 01                	push   $0x1
  23:	6a 01                	push   $0x1
  25:	e8 09 04 00 00       	call   433 <sem_init>
    sem_init(2, 1);
  2a:	59                   	pop    %ecx
  2b:	5b                   	pop    %ebx
  2c:	6a 01                	push   $0x1
  2e:	6a 02                	push   $0x2
  30:	e8 fe 03 00 00       	call   433 <sem_init>
    sem_init(3, 1);
  35:	58                   	pop    %eax
  36:	5a                   	pop    %edx
  37:	6a 01                	push   $0x1
  39:	6a 03                	push   $0x3
  3b:	e8 f3 03 00 00       	call   433 <sem_init>
    sem_init(4, 1);
  40:	59                   	pop    %ecx
  41:	5b                   	pop    %ebx
  42:	6a 01                	push   $0x1
  ...
  46:	31 db                	xor    %ebx,%ebx
    sem_init(4, 1);
  48:	e8 e6 03 00 00       	call   433 <sem_init>
    sem_init(5, 4);
  4d:	58                   	pop    %eax
  4e:	5a                   	pop    %edx
  4f:	6a 04                	push   $0x4
  51:	6a 05                	push   $0x5
  53:	e8 db 03 00 00       	call   433 <sem_init>
  58:	83 c4 10             	add    $0x10,%esp
    {
        int id = fork();
  5b:	e8 fb 02 00 00       	call   35b <fork>
        if(!id)
  60:	83 c3 01             	add    $0x1,%ebx
  63:	85 c0                	test   %eax,%eax
  65:	74 0a                	je     71 <main+0x71>
    for(int i = 0 ; i < 5 ; i++)
  67:	83 fb 05             	cmp    $0x5,%ebx
  6a:	75 ef                	jne    5b <main+0x5b>
            phil(i+1);
    }
    exit();
  6c:	e8 f2 02 00 00       	call   363 <exit>
            phil(i+1);
  71:	83 ec 0c             	sub    $0xc,%esp
  74:	53                   	push   %ebx
  75:	e8 06 00 00 00       	call   80 <phil>
  7a:	66 90                	xchg   %ax,%ax
  7c:	66 90                	xchg   %ax,%ax
  7e:	66 90                	xchg   %ax,%ax
...
00000080 <phil>:
{
  ...
  85:	ba 67 66 66 66       	mov    $0x66666667,%edx
{
  ...
  8e:	53                   	push   %ebx
        sem_acquire(phil_id % 5);
  8f:	bb 0a 00 00 00       	mov    $0xa,%ebx
{
  94:	83 ec 0c             	sub    $0xc,%esp
  97:	8b 7d 08             	mov    0x8(%ebp),%edi
        sem_acquire(phil_id % 5);
  9a:	89 f8                	mov    %edi,%eax
  ...
  ac:	8d 04 92             	lea    (%edx,%edx,4),%eax
  af:	29 c6                	sub    %eax,%esi
  b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        sem_acquire(5);
  b8:	83 ec 0c             	sub    $0xc,%esp
  bb:	6a 05                	push   $0x5
  bd:	e8 61 03 00 00       	call   423 <sem_acquire>
        sem_acquire(phil_id % 5);
  c2:	89 34 24             	mov    %esi,(%esp)
  c5:	e8 59 03 00 00       	call   423 <sem_acquire>
        sem_acquire(phil_id - 1);
  ca:	89 3c 24             	mov    %edi,(%esp)
  cd:	e8 51 03 00 00       	call   423 <sem_acquire>
        sem_release(phil_id % 5);
  d2:	89 34 24             	mov    %esi,(%esp)
  d5:	e8 51 03 00 00       	call   42b <sem_release>
        sem_release(phil_id - 1);
  da:	89 3c 24             	mov    %edi,(%esp)
  dd:	e8 49 03 00 00       	call   42b <sem_release>
        sem_release(5);
  e2:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  e9:	e8 3d 03 00 00       	call   42b <sem_release>
    for(int j = 0 ; j < 10 ; j++)
  ee:	83 c4 10             	add    $0x10,%esp
  f1:	83 eb 01             	sub    $0x1,%ebx
  f4:	75 c2                	jne    b8 <phil+0x38>
    exit();
  f6:	e8 68 02 00 00       	call   363 <exit>
  fb:	66 90                	xchg   %ax,%ax
  fd:	66 90                	xchg   %ax,%ax
  ff:	90                   	nop
...
0000040b <printProcess>:
 40b:	b8 17 00 00 00       	mov    $0x17,%eax
 410:	cd 40                	int    $0x40
 412:	c3                   	ret    

00000413 <changeProcessMHRRN>:
 413:	b8 18 00 00 00       	mov    $0x18,%eax
 418:	cd 40                	int    $0x40
 41a:	c3                   	ret    

0000041b <changeSystemMHRRN>:
...
free(void *ap)
{
 ...
 6c5:	a1 2c 0b 00 00       	mov    0xb2c,%eax
{
 ...
 6e6:	73 10                	jae    6f8 <free+0x38>
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	a3 2c 0b 00 00       	mov    %eax,0xb2c
}
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 719:	5d                   	pop    %ebp
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 2c 0b 00 00       	mov    %eax,0xb2c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 75d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 760:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a9:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 2c 0b 00 00       	mov    0xb2c,%eax
 ...
 804:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 807:	a3 2c 0b 00 00       	mov    %eax,0xb2c
}
 ...
 81e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 2c 0b 00 00 30 	movl   $0xb30,0xb2c
 827:	0b 00 00 
    base.s.size = 0;
 82a:	bf 30 0b 00 00       	mov    $0xb30,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 30 0b 00 00 30 	movl   $0xb30,0xb30
 836:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 83b:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 842:	00 00 00 
    if(p->s.size >= nunits){
