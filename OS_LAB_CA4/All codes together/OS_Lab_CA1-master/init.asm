...
main(void)
{
  ...
  c2:	50                   	push   %eax
  c3:	50                   	push   %eax
  c4:	68 94 0b 00 00       	push   $0xb94
  c9:	68 c8 08 00 00       	push   $0x8c8
  ce:	e8 d8 02 00 00       	call   3ab <exec>
      printf(1, "init: exec sh failed\n");
  d3:	5a                   	pop    %edx
  d4:	59                   	pop    %ecx
  d5:	68 cb 08 00 00       	push   $0x8cb
  da:	6a 01                	push   $0x1
...
00000433 <sem_acquire>:
 433:	b8 1a 00 00 00       	mov    $0x1a,%eax
 438:	cd 40                	int    $0x40
 43a:	c3                   	ret    

0000043b <sem_release>:
